        ...
        <div slot="content">
          <div class="box-inner ui-cart">
            <div>
              ...
              <!--列表-->
              <div class="cart-table" v-for="(item,i) in cartList" :key="i" v-if="item.checked == true || item.checked == 'true' ">
    ...
    methods: {
      ...
      _submitOrder () {
        ...
        for (var i = 0; i < this.cartList.length; i++) {
          if (this.cartList[i].checked === true || this.cartList[i].checked === 'true') {
