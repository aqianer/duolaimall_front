        ...
        <div class="registered">
          ...
          <div class="content" style="margin-top: 20px;">
            ...
            <el-checkbox class="agree" v-model="agreement">
              我已阅读并同意遵守
              <a @click="open('法律声明','本网站将会严格遵守国家和政府有关法律法规')">法律声明</a> 和
              <a @click="open('隐私条款','本网站将会严格遵守有关法律法规和本隐私政策所载明的内容收集、使用您的信息')">隐私条款</a>
            </el-checkbox>
            ...
            <ul class="common-form pr">
              ...
              <li style="text-align: center;line-height: 48px;margin-bottom: 0;font-size: 15px;color: #999;">
                <span>如果您已拥有 <span style="color:royalblue">多来买商城</span> 账号，则可在此</span>
                <a href="javascript:;"
                   style="margin: 0 5px"
                   @click="toLogin">登录</a>
              </li>
...
export default {
  ...
  methods: {
    ...
    regist () {
      ...
      if (!email || !userName || !userPwd || !userPwd2) {
        this.message('邮箱账号密码不能为空!')
        this.registxt = '注册'
        return false
      }
      if (userPwd2 !== userPwd) {
