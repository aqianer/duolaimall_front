            ...
            <div class="gray-sub-title cart-title">
              <div class="first">
                <div v-if="item.orderId">
                  ...
                  <span class="order-id" v-if="item.orderId.length <= 17"> 订单号： <a @click="orderDetail(item.orderId)">{{item.orderId}}</a> </span>
                  <span class="order-id" v-else> 订单号： <a @click="orderDetail(item.orderId)">{{item.orderId.slice(0, 14) + '...'}}</a> </span>
                </div>
                <div class="f-bc">
