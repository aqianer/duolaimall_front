...
const productSeckill = () => import('../page/Goods/goodsDetailsSeckill.vue')
const Cart = () => import('../page/Cart/cart.vue')
const checkoutSeckill = () => import('../page/Checkout/checkoutSeckill.vue')
...
const orderSeckillsuccess = () => import('../page/Checkout/orderSeckillsuccess.vue')
  ...
  routes: [
    {
      ...
      children: [
        ...
        {path: 'productSeckill/:productId', name: 'productSeckill', component: productSeckill},
    ...
    {path: '/checkoutSeckill', name: 'checkoutSeckill', component: checkoutSeckill},
    {path: '/refreshsearch', name: 'refreshsearch', component: RefreshSearch},
    {
      ...
      children: [
        ...
        {path: 'orderSeckillsuccess', name: 'orderSeckillsuccess', component: orderSeckillsuccess},
